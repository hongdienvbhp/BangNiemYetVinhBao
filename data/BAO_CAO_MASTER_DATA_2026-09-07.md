...
- Tổng mã được audit sau khi hợp nhất nguồn Vĩnh Bảo, 06 quyết định thành phố và ma trận kiểm chứng 51 TTHC: **245**
- Mã xuất hiện trong 06 quyết định cập nhật thành phố: **51**
- Mã Priority 51 được kiểm chứng pháp lý bổ sung: **37** (36 current/cấp xã; 01 bãi bỏ)
...
- TTHC trọng điểm đang public: **50/51**; mã còn lại `2.001009` là bãi bỏ
...
- `data/priority-51-legal-verification.json` kiểm chứng riêng 37 mã trọng điểm từng thiếu: 36 current/cấp xã; `2.001009` bãi bỏ theo QĐ 4517/QĐ-UBND ngày 10/11/2025.
...
8. Danh sách 51 TTHC không tự tạo thủ tục public; chỉ ma trận kiểm chứng pháp lý từ nguồn chính thức mới được phép bổ sung hoặc loại mã.
